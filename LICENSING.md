...
A `LICENSE-temporal` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [temporalio/temporal](https://github.com/temporalio/temporal), Copyright
2025 Temporal Technologies Inc.  All rights reserved, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../temporal-port/specs/SPEC-001-temporal.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
